...
AHI_FULLDISK_EXTENT = [85.0, -60.0, 205.0, 60.0]

# Resolutions of each channel type
AHI_CHANNEL_RES = {"vis": 0.01, "ext": 0.005, "sir": 0.02, "tir": 0.02}
...
class AHIGriddedFileHandler(BaseFileHandler):
    ...
    def __init__(self, filename, filename_info, filetype_info):
        ...
        super(AHIGriddedFileHandler, self).__init__(filename, filename_info, filetype_info)
    ...
    def _get_luts(self):
        ...
        logger.info("Download AHI LUTs files and store in directory %s", self.lut_dir)
    ...
    def get_area_def(self, dsid):
        ...
        area = geometry.AreaDefinition(
            "gridded_himawari", "A gridded Himawari area", "longlat", proj_param, self.ncols, self.nlines, area_extent
        )
        self.area = area
    ...
    def _read_data(self, fp_):
        ...
        return da.from_array(
            np.memmap(self.filename, offset=fp_.tell(), dtype=">u2", shape=(self.nlines, self.ncols), mode="r"),
            chunks=CHUNK_SIZE,
        )
