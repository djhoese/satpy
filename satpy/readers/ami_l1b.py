...
class AMIL1bNetCDF(BaseFileHandler):
    ...
    def __init__(
        ...
        allow_conditional_pixels=False,
        ...
        self.nc = xr.open_dataset(
            f_obj, decode_cf=True, mask_and_scale=False, chunks={"dim_image_x": CHUNK_SIZE, "dim_image_y": CHUNK_SIZE}
        )
    ...
    def _apply_user_rad_correction(self, data):
        ...
        rad_slope, rad_offset = get_user_calibration_factors(self.band_name, self.user_calibration)
        data = apply_rad_correction(data, rad_slope, rad_offset)
        return data
