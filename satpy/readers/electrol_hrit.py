...
goms_hdr_map.update({7: key_header, 128: segment_identification, 129: image_segment_line_quality})
...
time_cds_expanded = np.dtype(
    [("days", ">u2"), ("milliseconds", ">u4"), ("microseconds", ">u2"), ("nanoseconds", ">u2")]
)
...
class HRITGOMSPrologueFileHandler(HRITFileHandler):
    ...
    def __init__(self, filename, filename_info, filetype_info):
        ...
        super(HRITGOMSPrologueFileHandler, self).__init__(
            filename, filename_info, filetype_info, (goms_hdr_map, goms_variable_length_headers, goms_text_headers)
        )
...
epilogue = np.dtype(
    [("RadiometricProcessing", radiometric_processing, (10,)), ("GeometricProcessing", geometric_processing, (10,))]
)
...
class HRITGOMSEpilogueFileHandler(HRITFileHandler):
    ...
    def __init__(self, filename, filename_info, filetype_info):
        """Initialize the reader."""
        super(HRITGOMSEpilogueFileHandler, self).__init__(
            filename, filename_info, filetype_info, (goms_hdr_map, goms_variable_length_headers, goms_text_headers)
        )
        self.epilogue = {}
        self.read_epilogue()
...
SPACECRAFTS = {19001: "Electro-L N1", 19002: "Electro-L N2", 19003: "Electro-L N3"}
...
class HRITGOMSFileHandler(HRITFileHandler):
    ...
    def __init__(self, filename, filename_info, filetype_info, prologue, epilogue):
        """Initialize the reader."""
        super(HRITGOMSFileHandler, self).__init__(
            filename, filename_info, filetype_info, (goms_hdr_map, goms_variable_length_headers, goms_text_headers)
        )
