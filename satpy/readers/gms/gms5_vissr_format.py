...
COORDINATE_CONVERSION_PARAMETERS = np.dtype(
    [
        ...
        (
            "parameters",
            [
                ("judgement_of_observation_convergence_time", R4),
        ...
        ("reserved_3", I4, 529),
        (
            "correction_of_image_distortion",
            [
                ("stepping_angle_along_line_of_ir1", R4),
...
ATTITUDE_PREDICTION_DATA = np.dtype(
    [
        ("prediction_time_mjd", R8),
...
ORBIT_PREDICTION_DATA = [
    ...
    ("sat_sun_vector_1950", [("azimuth", R8), ("elevation", R8)]),
    ("sat_sun_vector_earth_fixed", [("azimuth", R8), ("elevation", R8)]),
    ("conversion_matrix", R8, (3, 3)),
    ("moon_directional_vector", R8, (3,)),
    ("satellite_position", [("ssp_longitude", R8), ("ssp_latitude", R8), ("satellite_height", R8)]),
...
VIS_CALIBRATION_TABLE = np.dtype(
    [
        ...
        ("brightness_table_for_calibration", [("universal_space_brightness", R4), ("solar_brightness", R4)]),
        (
            "calibration_uses_brightness_correspondence_voltage_chart",
            [("universal_space_voltage", R4), ("solar_voltage", R4)],
        ),
...
IR_CALIBRATION = np.dtype(
    [
        ...
        (
            "brightness_data_for_calibration",
            [("brightness_of_space", R4), ("brightness_of_black_body_shutter", R4), ("reserved", R4)],
        ),
        (
            "voltage_table_for_brightness_of_calibration",
            [("voltage_of_space", R4), ("voltage_of_black_body_shutter", R4), ("reserved", R4)],
        ),
        ("calibration_coefficients_of_radiation_observation", [("G", R4), ("V0", R4)]),
...
IMAGE_PARAMS = {
    "mode": {"dtype": MODE_BLOCK, "offset": {VIS_CHANNEL: 2 * BLOCK_SIZE_VIS, IR_CHANNEL: 2 * BLOCK_SIZE_IR}},
    "coordinate_conversion": {
        "dtype": COORDINATE_CONVERSION_PARAMETERS,
        "offset": {VIS_CHANNEL: 2 * BLOCK_SIZE_VIS + 2 * IMAGE_PARAM_ITEM_SIZE, IR_CHANNEL: 4 * BLOCK_SIZE_IR},
    },
    "attitude_prediction": {
        "dtype": ATTITUDE_PREDICTION,
        "offset": {VIS_CHANNEL: 2 * BLOCK_SIZE_VIS + 3 * IMAGE_PARAM_ITEM_SIZE, IR_CHANNEL: 5 * BLOCK_SIZE_IR},
        "preserve": "data",
    },
    "orbit_prediction_1": {
        "dtype": ORBIT_PREDICTION,
        "offset": {VIS_CHANNEL: 3 * BLOCK_SIZE_VIS, IR_CHANNEL: 6 * BLOCK_SIZE_IR},
        "preserve": "data",
    },
    "orbit_prediction_2": {
        "dtype": ORBIT_PREDICTION,
        "offset": {VIS_CHANNEL: 3 * BLOCK_SIZE_VIS + 1 * IMAGE_PARAM_ITEM_SIZE, IR_CHANNEL: 7 * BLOCK_SIZE_IR},
        "preserve": "data",
    },
    "vis_calibration": {
        "dtype": VIS_CALIBRATION,
        "offset": {VIS_CHANNEL: 3 * BLOCK_SIZE_VIS + 3 * IMAGE_PARAM_ITEM_SIZE, IR_CHANNEL: 9 * BLOCK_SIZE_IR},
        "preserve": "data",
    },
    "ir1_calibration": {
        "dtype": IR_CALIBRATION,
        "offset": {VIS_CHANNEL: 4 * BLOCK_SIZE_VIS, IR_CHANNEL: 10 * BLOCK_SIZE_IR},
    },
    "ir2_calibration": {
        "dtype": IR_CALIBRATION,
        "offset": {VIS_CHANNEL: 4 * BLOCK_SIZE_VIS + IMAGE_PARAM_ITEM_SIZE, IR_CHANNEL: 11 * BLOCK_SIZE_IR},
    },
    "wv_calibration": {
        "dtype": IR_CALIBRATION,
        "offset": {VIS_CHANNEL: 4 * BLOCK_SIZE_VIS + 2 * IMAGE_PARAM_ITEM_SIZE, IR_CHANNEL: 12 * BLOCK_SIZE_IR},
    },
    "simple_coordinate_conversion_table": {
        "dtype": SIMPLE_COORDINATE_CONVERSION_TABLE,
        "offset": {VIS_CHANNEL: 5 * BLOCK_SIZE_VIS + 2 * IMAGE_PARAM_ITEM_SIZE, IR_CHANNEL: 16 * BLOCK_SIZE_IR},
    },
}
...
IMAGE_DATA_BLOCK_IR = np.dtype([("LCW", LINE_CONTROL_WORD), ("DOC", U1, (256,)), ("image_data", U1, 3344)])  # Omitted

IMAGE_DATA_BLOCK_VIS = np.dtype(
    [("LCW", LINE_CONTROL_WORD), ("DOC", U1, (64,)), ("image_data", U1, (13376,))]  # Omitted
)
...
IMAGE_DATA = {
    ...
    IR_CHANNEL: {"offset": 18 * BLOCK_SIZE_IR, "dtype": IMAGE_DATA_BLOCK_IR},
}
