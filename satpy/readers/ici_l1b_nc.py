...
class IciL1bNCFileHandler(NetCDF4FileHandler):
    ...
    def _interpolate_viewing_angle(
        ...
        azimuth, zenith = self._interpolate_geo(azimuth, 90.0 - zenith, n_samples)
    ...
    def _interpolate(
        ...
        try:
            ...
            logger.warning(
                f"Datasets for {interpolation_type.name} interpolation not correctly defined in YAML file"
            )  # noqa: E501
        return None, None
    ...
    def _calibrate(self, variable, dataset_info):
        ...
        if calibration_name == "brightness_temperature":
            ...
            raise ValueError(
                "Unknown calibration %s for dataset %s" % (calibration_name, dataset_info["name"])
            )  # noqa: E501
    ...
    def _orthorectify(self, variable, orthorect_data_name):
        ...
        try:
            ...
            logger.warning(
                "Required dataset %s for orthorectification not available, skipping", orthorect_data_name
            )  # noqa: E501
        return variable
