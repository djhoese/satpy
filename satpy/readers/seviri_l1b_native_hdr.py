...
class L15MainProductHeaderRecord(object):
    ...
    def get(self):
        ...
        l15_ph_data_identification = [("Name", "S30"), ("Size", "S16"), ("Address", "S16")]
...
class L15DataHeaderRecord(object):
    ...
    def image_acquisition(self):
        ...
        radiometer_status = [("ChannelStatus", (np.uint8, 12)), ("DetectorStatus", (np.uint8, 42))]
    ...
    def celestial_events(self):
        ...
        record = [("CelestialBodiesPosition", ephemeris), ("RelationToImage", relation_to_image)]
    ...
    def image_description(self):
        ...
        projection_description = [("TypeOfProjection", np.uint8), ("LongitudeOfSSP", np.float32)]
    ...
    def radiometric_processing(self):
        ...
        level_15_image_calibration = [("CalSlope", np.float64), ("CalOffset", np.float64)]
        ...
        baffle_temperature = [("FCUNominalM1BaffleTemp", np.uint16), ("FCURedundantM1BaffleTemp", np.uint16)]
        ...
        fcu_mode = [("FCUNominalSMMStatus", "S2"), ("FCURedundantSMMStatus", "S2")]
        ...
        black_body_data_used = [("BBObservationUTC", time_cds_expanded), ("BBRelatedData", bb_related_data)]
    ...
    def geometric_processing(self):
        ...
        opt_axis_distances = [("E-WFocalPlane", (np.float32, 42)), ("N_SFocalPlane", (np.float32, 42))]
    ...
    def impf_configuration(self):
        ...
        overall_configuration = [("Issue", np.uint16), ("Revision", np.uint16)]

        sw_version = overall_configuration

        info_base_versions = sw_version

        su_configuration = [("SWVersion", sw_version), ("InfoBaseVersions", (info_base_versions, 10))]
        ...
        equalisation_params = [("ConstCoeff", np.float32), ("LinearCoeff", np.float32), ("QuadraticCoeff", np.float32)]
...
hrit_epilogue = np.dtype(Msg15NativeTrailerRecord().seviri_l15_trailer).newbyteorder(">")
hrit_prologue = HritPrologue().get()
impf_configuration = np.dtype(L15DataHeaderRecord().impf_configuration).newbyteorder(">")
