...
data_center_dict = {
    55: {"ssp": "E0415", "name": "08"},
    56: {"ssp": "E0455", "name": "09"},
    57: {"ssp": "E0095", "name": "10"},
    70: {"ssp": "E0000", "name": "11"},
}

seg_size_dict = {
    "seviri_l2_bufr_asr": 16,
    "seviri_l2_bufr_cla": 16,
    "seviri_l2_bufr_csr": 16,
    "seviri_l2_bufr_gii": 3,
    "seviri_l2_bufr_thu": 16,
    "seviri_l2_bufr_toz": 3,
    ...
    **Defining dataset recticifation longitude**
    ...
    def __init__(
        ...
        **kwargs,
        ...
        super(SeviriL2BufrFileHandler, self).__init__(filename, filename_info, filetype_info)
    ...
    def _construct_area_def(self, dataset_id):
        ...
        area_naming = get_geos_area_naming({**area_naming_input_dict, **get_service_mode("seviri", self.ssp_lon)})
