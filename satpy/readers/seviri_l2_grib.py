...
class SeviriL2GribFileHandler(BaseFileHandler):
    ...
    def _get_proj_area(self, gid):
        ...
        area_naming = get_geos_area_naming({**area_naming_input_dict, **get_service_mode("seviri", self._ssp_lon)})
    ...
    def _get_xarray_from_msg(self, gid):
        ...
        xarr = xr.DataArray(
            da.from_array(ec.codes_get_values(gid).reshape(self._nrows, self._ncols), CHUNK_SIZE), dims=("y", "x")
        )
    ...
    def _get_attributes(self):
        ...
        """
        orbital_parameters = {"projection_longitude": self._ssp_lon}
