...
class VaisalaGLD360TextFileHandler(BaseFileHandler):
    ...
    def __init__(self, filename, filename_info, filetype_info):
        ...
        self.data = pd.read_csv(
            filename, delim_whitespace=True, header=None, names=names, dtype=dtypes, parse_dates=parse_dates
        )
    ...
    def get_dataset(self, dataset_id, dataset_info):
        """Load a dataset."""
        xarr = xr.DataArray(da.from_array(self.data[dataset_id["name"]], chunks=CHUNK_SIZE), dims=["y"])
