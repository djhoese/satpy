...
class ViiNCBaseFileHandler(NetCDF4FileHandler):
    ...
    def _perform_interpolation(variable):
        ...
        """
        interpolated_values = tie_points_interpolation([variable], SCAN_ALT_TIE_POINTS, TIE_POINTS_FACTOR)[0]
        new_variable = interpolated_values.rename(num_tie_points_act="num_pixels", num_tie_points_alt="num_lines")
    ...
    def _perform_geo_interpolation(longitude, latitude):
        ...
        interpolated_longitude, interpolated_latitude = tie_points_geo_interpolation(
            longitude, latitude, SCAN_ALT_TIE_POINTS, TIE_POINTS_FACTOR
        )
        new_longitude = interpolated_longitude.rename(num_tie_points_act="num_pixels", num_tie_points_alt="num_lines")
        new_longitude.name = longitude.name
        new_longitude.attrs = longitude.attrs
        new_latitude = interpolated_latitude.rename(num_tie_points_act="num_pixels", num_tie_points_alt="num_lines")
