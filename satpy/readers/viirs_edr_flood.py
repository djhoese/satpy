...
class VIIRSEDRFlood(HDF4FileHandler):
    ...
    def get_area_def(self, ds_id):
        ...
        proj_dict = {"proj": "latlong", "datum": "WGS84", "ellps": "WGS84", "no_defs": True}

        area_extent = [
            data.attrs.get("ProjectionMinLongitude"),
            data.attrs.get("ProjectionMinLatitude"),
            data.attrs.get("ProjectionMaxLongitude"),
            data.attrs.get("ProjectionMaxLatitude"),
        ]
