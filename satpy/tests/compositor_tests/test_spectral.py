...
class TestSpectralComposites:
    ...
    def test_bad_lengths(self):
        ...
        comp = SpectralBlender(
            "blended_channel",
            fractions=(0.3, 0.7),
            prerequisites=(0.51, 0.85),
    ...
    def test_hybrid_green(self):
        ...
        comp = HybridGreen(
            "hybrid_green", fraction=0.15, prerequisites=(0.51, 0.85), standard_name="toa_bidirectional_reflectance"
        )
    ...
    def test_ndvi_hybrid_green(self):
        ...
        self.c01 = xr.DataArray(
            da.from_array([[0.25, 0.30], [0.20, 0.30]], chunks=25), dims=("y", "x"), attrs={"name": "C02"}
        )
        self.c02 = xr.DataArray(
            da.from_array([[0.25, 0.30], [0.25, 0.35]], chunks=25), dims=("y", "x"), attrs={"name": "C03"}
        )
        self.c03 = xr.DataArray(
            da.from_array([[0.35, 0.35], [0.28, 0.65]], chunks=25), dims=("y", "x"), attrs={"name": "C04"}
        )

        comp = NDVIHybridGreen(
            "ndvi_hybrid_green",
            limits=(0.15, 0.05),
            prerequisites=(0.51, 0.65, 0.85),
            standard_name="toa_bidirectional_reflectance",
