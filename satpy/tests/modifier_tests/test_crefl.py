...
def _make_viirs_xarray(data, area, name, standard_name, wavelength=None, units="degrees", calibration=None):
    return xr.DataArray(
        ...
        attrs={
            ...
            "end_time": datetime(2012, 2, 25, 18, 11, 21, 175760),
            "area": area,
            "ancillary_variables": [],
        },
    )
...
class TestReflectanceCorrectorModifier:
    ...
    def test_reflectance_corrector_modis(self):
        ...
        def make_xarray(name, calibration, wavelength=None, modifiers=None, resolution=1000):
            return xr.DataArray(
                ...
                attrs={
                    ...
                    "sensor": "modis",
                    "units": "%",
                    "start_time": datetime(2012, 8, 13, 18, 46, 1, 439838),
                    "end_time": datetime(2012, 8, 13, 18, 57, 47, 746296),
                    "area": area,
                    "ancillary_variables": [],
                },
            )
        ...
        c01 = make_xarray(
            "1", "reflectance", wavelength=(0.62, 0.645, 0.67), modifiers="sunz_corrected", resolution=500
        )
