...
def l2_lef_schema(settings=None):
    ...
    return {
        ...
        "variables": {
            ...
            "l1b_missing_warning": {"format": "i1", "shape": ("scalar",), "default_data": lambda: 0},
            "l1b_radiometric_warning": {"format": "i1", "shape": ("scalar",), "default_data": lambda: 0},
        },
        "sector_variables": {
            "event_id": {
                "format": "u4",
...
def l2_af_schema(settings=None):
    ...
    return {
        ...
        "variables": {
            "accumulation_offsets": {"format": "u4", "shape": ("accumulations",), "default_data": lambda: 0},
            ...
            "average_flash_qa": {"format": "i1", "shape": ("accumulations",), "default_data": lambda: 23},
            "flash_accumulation": {
                "format": "u2",
                "shape": ("pixels",),
