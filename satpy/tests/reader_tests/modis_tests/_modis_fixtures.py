...
def _get_angles_variable_info(resolution: int) -> dict:
    ...
    angle_info = {
        ...
        "fill_value": -32767,
        "attrs": {
            "dim_labels": [f"{dim_factor}*nscans:MODIS_SWATH_Type_L1B", "1KM_geo_dim:MODIS_SWATH_Type_L1B"],
            "scale_factor": 0.01,
            "add_offset": -0.01,
        },
    }
    ...
    return {
        var_name: {
            ...
            "attrs": {
                ...
                "dim_labels": [band_dim_name, row_dim_name, col_dim_name],
                "valid_range": (0, 32767),
...
def _get_l1b_geo_variable_info(filename: str, geo_resolution: int, include_angles: bool = True) -> dict:
    variables_info = {}
...
def _get_cloud_mask_variable_info(var_name: str, resolution: int) -> dict:
    ...
    return {
        var_name: {
            ...
            "attrs": {
                # dim_labels are just unique dimension names, may not match exactly with real world files
                "dim_labels": [byte_dim_name, row_dim_name, col_dim_name],
                "valid_range": (0, -1),
                "scale_factor": 1.0,
                "add_offset": 0.0,
            },
        ...
        "Quality_Assurance": {
            ...
            "attrs": {
                # dim_labels are just unique dimension names, may not match exactly with real world files
                "dim_labels": [row_dim_name, col_dim_name, "Quality_Dimension:mod35"],
                "valid_range": (0, -1),
                "scale_factor": 2.0,
                "add_offset": -0.5,
            },
