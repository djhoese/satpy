...
class TestModisL1b:
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            [
                ...
                AVAILABLE_HKM_PRODUCT_NAMES + AVAILABLE_QKM_PRODUCT_NAMES,
                [500],
                [1000, 500, 250],
            ],
            [lazy_fixture("modis_l1b_nasa_mod02qkm_file"), AVAILABLE_QKM_PRODUCT_NAMES, [250], [1000, 500, 250]],
        ],
    )
    ...
    @pytest.mark.parametrize(
        ...
        [
            [lazy_fixture("modis_l1b_nasa_mod021km_file"), True, False, False, 1000],
            [lazy_fixture("modis_l1b_imapp_1000m_file"), True, False, False, 1000],
            [lazy_fixture("modis_l1b_nasa_mod02hkm_file"), False, True, True, 250],
            [lazy_fixture("modis_l1b_nasa_mod02qkm_file"), False, True, True, 250],
            [lazy_fixture("modis_l1b_nasa_1km_mod03_files"), True, True, True, 250],
        ],
    )
    ...
    def test_load_vis_saturation(self, mask_saturated, modis_l1b_nasa_mod021km_file):
        """Test loading visible band."""
        scene = Scene(
            reader="modis_l1b", filenames=modis_l1b_nasa_mod021km_file, reader_kwargs={"mask_saturated": mask_saturated}
        )
        dataset_name = "2"
        with dask.config.set({"array.chunk-size": "1 MiB"}):
            scene.load([dataset_name])
