...
class TestMHS_AMSUB_AAPPL1CReadData(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self._header["tempradcnv"][0] = [
            [2968720, 0, 1000000, 5236956, 0],
        ...
        self.filename_info = {
            "platform_shortname": "metop01",
            "start_time": datetime.datetime(2020, 9, 17, 10, 6),
            "orbit_number": 41509,
        }

        self.filetype_info = {
            "file_reader": MHS_AMSUB_AAPPL1CFile,
    ...
    def test_read(self):
        ...
        with tempfile.TemporaryFile() as tmpfile:
            ...
            chmax = [267.98, 274.87, 248.85, 256.16, 263.0]
