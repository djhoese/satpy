...
class FakeNetCDF4FileHandler2(FakeNetCDF4FileHandler):
    ...
    def get_test_content(self, filename, filename_info, filetype_info):
        ...
        file_content["lat/attr/valid_min"] = -90.0
        file_content["lat/attr/valid_max"] = 90.0
        ...
        file_content["lon/attr/valid_min"] = -180.0
        file_content["lon/attr/valid_max"] = 180.0
        file_content["lon/shape"] = DEFAULT_FILE_SHAPE

        for k in ["sea_surface_temperature", "satellite_zenith_angle", "sea_ice_fraction", "wind_speed"]:
        ...
        file_content["l2p_flags"] = np.zeros((1, DEFAULT_FILE_SHAPE[0], DEFAULT_FILE_SHAPE[1]), dtype=np.uint16)
...
class TestACSPOReader:
    ...
    def test_load_every_dataset(self):
        ...
        r.create_filehandlers(loadables)
        datasets = r.load(["sst", "satellite_zenith_angle", "sea_ice_fraction", "wind_speed"])
