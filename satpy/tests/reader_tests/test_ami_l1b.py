...
class TestAMIL1bNetCDF(TestAMIL1bNetCDFBase):
    ...
    def test_basic_attributes(self):
        ...
        self.assertEqual(self.reader.start_time, datetime(2019, 9, 30, 3, 0, 31, 957882))
        self.assertEqual(self.reader.end_time, datetime(2019, 9, 30, 3, 9, 35, 606133))
    ...
    def test_get_area_def(self, adef):
        ...
        exp = {"a": 6378137.0, "b": 6356752.3, "h": 35785863.0, "lon_0": 128.2, "proj": "geos", "units": "m"}
        for key, val in exp.items():
...
class TestAMIL1bNetCDFIRCal(TestAMIL1bNetCDFBase):
    ...
    def setUp(self):
        ...
        self.ds_id = make_dataid(name="IR087", wavelength=[8.415, 8.59, 8.765], calibration="brightness_temperature")
        self.ds_info = {
            "file_key": "image_pixel_values",
    ...
    def test_default_calibrate(self):
        ...
        expected = np.array(
            [
                [238.34385135, 238.31443527, 238.28500087, 238.25554813, 238.22607701],
    ...
    def test_gsics_radiance_corr(self):
        ...
        expected = np.array(
            [
                [238.036797, 238.007106, 237.977396, 237.947668, 237.91792],
    ...
    def test_user_radiance_corr(self):
        ...
        self.reader.calib_mode = "FILE"
        self.reader.user_calibration = {"IR087": {"slope": 0.99669, "offset": 0.16907}}
        expected = np.array(
            [
                [238.073713, 238.044043, 238.014354, 237.984647, 237.954921],
