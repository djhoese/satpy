...
class TestAMSR2L1BReader(unittest.TestCase):
    ...
    def test_load_basic(self):
        ...
        for d in ds.values():
            ...
            self.assertTupleEqual(d.attrs["area"].lons.shape, (DEFAULT_FILE_SHAPE[0], DEFAULT_FILE_SHAPE[1] // 2))
            self.assertTupleEqual(d.attrs["area"].lats.shape, (DEFAULT_FILE_SHAPE[0], DEFAULT_FILE_SHAPE[1] // 2))
    ...
    def test_load_89ghz(self):
        ...
        for d in ds.values():
            ...
            self.assertIn("area", d.attrs)
            self.assertIsNotNone(d.attrs["area"])
            self.assertTupleEqual(d.attrs["area"].lons.shape, DEFAULT_FILE_SHAPE)
            self.assertTupleEqual(d.attrs["area"].lats.shape, DEFAULT_FILE_SHAPE)
