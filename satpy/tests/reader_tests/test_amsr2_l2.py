...
class TestAMSR2L2Reader(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.p = mock.patch.object(AMSR2L2FileHandler, "__bases__", (FakeHDF5FileHandler2, AMSR2L1BFileHandler))
    ...
    def test_load_basic(self):
        ...
        for d in ds.values():
            ...
            self.assertTupleEqual(d.attrs["area"].lons.shape, (DEFAULT_FILE_SHAPE[0], DEFAULT_FILE_SHAPE[1]))
            self.assertTupleEqual(d.attrs["area"].lats.shape, (DEFAULT_FILE_SHAPE[0], DEFAULT_FILE_SHAPE[1]))
