...
class TestRecarray2Dict(unittest.TestCase):
    ...
    def test_timestamps(self):
        ...
        pat = np.array(
            [[[((21916, 41409544, 305, 262), (21916, 42160340, 659, 856), (21916, 42309417, 918, 443))]]], dtype=pat_dt
        )
    ...
    def test_mpef_product_header(self):
        ...
        names = ["ImageLocation", "GsicsCalMode", "GsicsCalValidity", "Padding", "OffsetToData", "Padding2"]
        mpef_header = np.dtype([(name, mpef_product_header.fields[name][0]) for name in names])
