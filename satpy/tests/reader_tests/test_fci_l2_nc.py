...
AREA_DEF = geometry.AreaDefinition(
    ...
    "",
    {"h": 35786400.0, "lon_0": 0.0, "ellps": "WGS84", "proj": "geos", "units": "m"},
    5568,
    5568,
...
class TestFciL2NCFileHandler(unittest.TestCase):
    ...
    def setUp(self):
        ...
        with Dataset(self.test_file, "w") as nc:
            ...
            one_layer_dataset = nc.createVariable(
                "test_one_layer", np.float32, dimensions=("number_of_rows", "number_of_columns")
            )
            one_layer_dataset[:] = np.ones((100, 10))
            one_layer_dataset.test_attr = "attr"
            one_layer_dataset.units = "test_units"

            two_layers_dataset = nc.createVariable(
                "test_two_layers",
                np.float32,
                dimensions=("maximum_number_of_layers", "number_of_rows", "number_of_columns"),
            )
            ...
            mtg_geos_projection.semi_major_axis = 6378137.0
            mtg_geos_projection.inverse_flattening = 298.257223563
            mtg_geos_projection.perspective_point_height = 35786400.0
    ...
    def test_area_definition(self, me_, gad_):
        ...
        np.testing.assert_allclose(args, [-0.0, -515.6620, 5672.28217, 0.0, 35786400.0])
    ...
    def test_dataset(self):
        ...
        dataset = self.fh.get_dataset(
            make_dataid(name="test_one_layer", resolution=2000),
            {"name": "test_one_layer", "file_key": "test_one_layer", "fill_value": -999, "file_type": "test_file_type"},
        )
    ...
    def test_dataset_with_layer(self):
        ...
        dataset = self.fh.get_dataset(
            make_dataid(name="test_two_layers", resolution=2000),
            {
    ...
    def test_dataset_with_invalid_filekey(self):
        ...
        invalid_dataset = self.fh.get_dataset(
            make_dataid(name="test_invalid", resolution=2000),
            {"name": "test_invalid", "file_key": "test_invalid", "fill_value": -999, "file_type": "test_file_type"},
        )
    ...
    def test_dataset_with_total_cot(self):
        ...
        dataset = self.fh.get_dataset(
            make_dataid(name="retrieved_cloud_optical_thickness", resolution=2000),
            {
    ...
    def test_dataset_with_scalar(self):
        ...
        dataset = self.fh.get_dataset(
            ...
            {"name": "product_quality", "file_key": "product_quality", "file_type": "test_file_type"},
        )
        self.assertEqual(dataset.values, 99.0)
...
class TestFciL2NCSegmentFileHandler(unittest.TestCase):
    ...
    def setUp(self):
        ...
        with Dataset(self.seg_test_file, "w") as nc:
            ...
            test_dataset = nc.createVariable(
                "test_values",
                np.float32,
                dimensions=("number_of_FoR_rows", "number_of_FoR_cols", "number_of_channels", "number_of_categories"),
            )
    ...
    def test_dataset_with_adef(self):
        ...
        self.fh = FciL2NCSegmentFileHandler(
            filename=self.seg_test_file, filename_info={}, filetype_info={}, with_area_definition=True
        )
    ...
    def test_dataset_slicing_catid(self):
        ...
        dataset = self.fh.get_dataset(
            make_dataid(name="test_values", resolution=32000),
            {"name": "test_values", "file_key": "test_values", "fill_value": -999, "category_id": 5},
        )
    ...
    def test_dataset_slicing_chid_catid(self):
        ...
        dataset = self.fh.get_dataset(
            make_dataid(name="test_values", resolution=32000),
            {"name": "test_values", "file_key": "test_values", "fill_value": -999, "channel_id": 0, "category_id": 1},
        )
    ...
    def test_dataset_slicing_irid(self):
        ...
        dataset = self.fh.get_dataset(
            make_dataid(name="test_values", resolution=32000),
            {"name": "test_values", "file_key": "test_values", "fill_value": -999, "ir_channel_id": 4},
        )
...
class TestFciL2NCReadingByteData(unittest.TestCase):
    ...
    def setUp(self):
        ...
        with Dataset(self.test_byte_file, "w") as nc_byte:
            ...
            test_dataset = nc_byte.createVariable(
        ...
        self.byte_reader = FciL2NCFileHandler(filename=self.test_byte_file, filename_info={}, filetype_info={})
    ...
    def test_byte_extraction(self):
        ...
        dataset = self.byte_reader.get_dataset(
            make_dataid(name="cloud_mask_test_flag", resolution=2000),
            {
