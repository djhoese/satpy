...
class FakeNetCDF4FileHandler2(FakeNetCDF4FileHandler):
    ...
    def get_test_content(self, filename, filename_info, filetype_info):
        ...
        if filename_info["platform_shortname"] == "HIMAWARI-8":
            file_content["pixel_longitude"] = DEFAULT_LON_DATA + 130.0

        file_content["variable1"] = DEFAULT_FILE_DATA.astype(np.float32)
        file_content["variable1/attr/_FillValue"] = -1
        file_content["variable1/attr/scale_factor"] = 1.0
        file_content["variable1/attr/add_offset"] = 0.0
        ...
        file_content["variable2"] = np.ma.masked_array(
            DEFAULT_FILE_DATA.astype(np.float32), mask=np.zeros_like(DEFAULT_FILE_DATA)
        )
        file_content["variable2"].mask[::5, ::5] = True
        file_content["variable2/attr/_FillValue"] = -1
        file_content["variable2/attr/scale_factor"] = 1.0
        file_content["variable2/attr/add_offset"] = 0.0
        ...
        convert_file_content_to_data_array(file_content, attrs=attrs, dims=("z", "lines", "elements"))
        return file_content
