...
class TestGEOSProjectionUtil(unittest.TestCase):
    ...
    def make_pdict_ext(self, typ, scan):
        ...
        if typ == 1:  # Fulldisk
            ...
            if scan == "N2S":
                pdict["scandir"] = "N2S"
                pdict["loff"] = 1856
                extent = (5567248.28340708, 5567248.28340708, -5570248.686685662, -5570248.686685662)

            if scan == "S2N":
                pdict["scandir"] = "S2N"
                pdict["loff"] = -1856
                extent = (5567248.28340708, 5570248.686685662, -5570248.686685662, -5567248.28340708)
        ...
        if typ == 2:  # One sector
            ...
            if scan == "N2S":
                pdict["scandir"] = "N2S"
                pdict["loff"] = 464
                extent = (5567248.28340708, 1390686.9196223018, -5570248.686685662, -1500.2016392905093)

            if scan == "S2N":
                pdict["scandir"] = "S2N"
                pdict["loff"] = 464
                extent = (5567248.28340708, -1390686.9196223018, -5570248.686685662, -2782874.0408838945)
    ...
    def test_get_geos_area_naming(self):
        ...
        self.assertEqual(
            output_dict["description"], "TESTPLATFORM TESTINSTRUMENT testdesc area definition with 1 km resolution"
        )
