...
def setup_fake_dataset():
    ...
    fed = (np.arange(10.0).reshape((2, 5)) + 1.0) * 50.0
    fed = (fed + 1.0) / 0.5
...
class TestGLML2FileHandler(unittest.TestCase):
    ...
    def setUp(self, xr_):
        ...
        self.reader = NCGriddedGLML2(
            "filename",
            {"platform_shortname": "G16", "scene_abbr": "C", "scan_mode": "M3"},
    ...
    def test_basic_attributes(self):
        ...
        self.assertEqual(self.reader.start_time, datetime(2017, 9, 20, 17, 30, 40))
        self.assertEqual(self.reader.end_time, datetime(2017, 9, 20, 17, 41, 17))
