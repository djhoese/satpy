...
test_pro = {
    "TISTR": datetime.datetime(2018, 5, 9, 21, 33, 27, 999000),
...
class TestHRITGOESFileHandler(unittest.TestCase):
    ...
    def setUp(self, new_fh_init):
        ...
        blob = "$HALFTONE:=10\r\n_NAME:=albedo\r\n_UNIT:=percent\r\n0:=0.0\r\n1023:=100.0\r\n".encode()
        mda = {
            "projection_parameters": {"SSP_longitude": -123.0},
    ...
    def test_get_area_def(self):
        ...
        area_extent_exp = (-5639254.900260435, 1925159.4881528523, 5643261.475678028, 3784210.48191544)
