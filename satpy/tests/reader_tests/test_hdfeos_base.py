    ...
    "INVENTORYMETADATA": {
        "ADDITIONALATTRIBUTES": {
            "ADDITIONALATTRIBUTESCONTAINER": {
                "ADDITIONALATTRIBUTENAME": {"VALUE": "identifier_product_doi_authority"},
        ...
        "ASSOCIATEDPLATFORMINSTRUMENTSENSOR": {
            "ASSOCIATEDPLATFORMINSTRUMENTSENSORCONTAINER": {
                "ASSOCIATEDINSTRUMENTSHORTNAME": {"VALUE": "MODIS"},
                "ASSOCIATEDPLATFORMSHORTNAME": {"VALUE": "Aqua"},
                "ASSOCIATEDSENSORSHORTNAME": {"VALUE": "MODIS"},
            }
        },
        "COLLECTIONDESCRIPTIONCLASS": {"SHORTNAME": {"VALUE": "MYD03"}, "VERSIONID": {"VALUE": 61}},
        "ECSDATAGRANULE": {
            "DAYNIGHTFLAG": {"VALUE": "Day"},
            "LOCALGRANULEID": {"VALUE": "MYD03.A2019051.1225.061.2019051131153.NRT.hdf"},
            "LOCALVERSIONID": {"VALUE": "6.0.4"},
            "PRODUCTIONDATETIME": {"VALUE": "2019-02-20T13:11:53.000Z"},
            "REPROCESSINGACTUAL": {"VALUE": "Near Real Time"},
            "REPROCESSINGPLANNED": {"VALUE": "further update is anticipated"},
        },
        "GROUPTYPE": "MASTERGROUP",
        "INPUTGRANULE": {
            "INPUTPOINTER": {
        ...
        "MEASUREDPARAMETER": {
            "MEASUREDPARAMETERCONTAINER": {
                "PARAMETERNAME": {"VALUE": "Geolocation"},
                "QAFLAGS": {
                    "AUTOMATICQUALITYFLAG": {"VALUE": "Passed"},
                    "AUTOMATICQUALITYFLAGEXPLANATION": {
                        "VALUE": "Set to 'Failed' if processing error occurred, set to 'Passed' otherwise"
                    },
                    "SCIENCEQUALITYFLAG": {"VALUE": "Not Investigated"},
                },
                "QASTATS": {"QAPERCENTMISSINGDATA": {"VALUE": 0}, "QAPERCENTOUTOFBOUNDSDATA": {"VALUE": 0}},
            }
        },
        "ORBITCALCULATEDSPATIALDOMAIN": {
            "ORBITCALCULATEDSPATIALDOMAINCONTAINER": {
                "EQUATORCROSSINGDATE": {"VALUE": "2019-02-20"},
                "EQUATORCROSSINGLONGITUDE": {"VALUE": -151.260740805733},
                "EQUATORCROSSINGTIME": {"VALUE": "12:49:52.965727"},
                "ORBITNUMBER": {"VALUE": 89393},
            }
        },
        "PGEVERSIONCLASS": {"PGEVERSION": {"VALUE": "6.1.4"}},
        "RANGEDATETIME": {
            "RANGEBEGINNINGDATE": {"VALUE": "2019-02-20"},
        ...
        "SPATIALDOMAINCONTAINER": {
            "HORIZONTALSPATIALDOMAINCONTAINER": {
                "GPOLYGON": {
                    "GPOLYGONCONTAINER": {
                        "GRING": {"EXCLUSIONGRINGFLAG": {"VALUE": "N"}},
                        "GRINGPOINT": {
                            "GRINGPOINTLATITUDE": {
                                "VALUE": (29.5170117594673, 26.1480434828114, 43.2445462598877, 47.7959787025408)
                            },
                            ...
                            "GRINGPOINTSEQUENCENO": {"VALUE": (1, 2, 3, 4)},
                        },
                    }
                }
            }
...
class TestReadMDA(unittest.TestCase):
    ...
    def test_read_mda_geo_resolution(self):
        ...
        resolution_l1b = HDFEOSGeoReader.read_geo_resolution(HDFEOSGeoReader.read_mda(metadata_modisl1b))
        self.assertEqual(resolution_l1b, 1000)
        resolution_l2 = HDFEOSGeoReader.read_geo_resolution(HDFEOSGeoReader.read_mda(metadata_modisl2))
