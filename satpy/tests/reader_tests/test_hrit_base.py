...
mda = {
    "file_type": 0,
    "total_header_length": 6198,
    "data_field_length": 17223680,
    "number_of_bits_per_pixel": 10,
    "number_of_columns": 3712,
    "number_of_lines": 464,
...
class TestHRITFileHandler:
    ...
    def setup_method(self, method):
        ...
        with mock.patch.object(HRITFileHandler, "_get_hd", new=new_get_hd):
            self.reader = HRITFileHandler(
                "filename",
                {"platform_shortname": "MSG3", "start_time": datetime(2016, 3, 3, 0, 0)},
                {"filetype": "info"},
    ...
    def test_get_area_extent(self):
        ...
        exp = (-71717.44995740513, -71717.44995740513, 79266.655216079365, 79266.655216079365)
        assert res == exp
    ...
    def test_get_area_def(self):
        ...
        assert area.area_extent == (-77771774058.38356, -77771774058.38356, 30310525626438.438, 3720765401003.719)
