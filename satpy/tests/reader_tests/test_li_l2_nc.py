...
class TestLIL2:
    ...
    def test_dataset_loading(self, filetype_infos):
        ...
        for ptype, pinfo in products_dict.items():
            ftype = pinfo["ftype"]
            filename_info = {"start_time": "0000", "end_time": "1000"}
    ...
    def test_filename_infos(self, filetype_infos):
        ...
        filename_info = {"start_time": "20101112131415", "end_time": "20101112131416"}
    ...
    def test_get_first_valid_variable(self, filetype_infos):
        ...
        mix1 = handler.get_first_valid_variable(
            ["dummy/path", "data/north/event_id", "data/east/event_id", "data/south/group_id"]
        )

        mix2 = handler.get_first_valid_variable(
            ["dummy/path", "data/west/group_id", "data/north/event_id", "data/east/event_id", "data/south/group_id"]
        )
    ...
    def test_combine_info(self, filetype_infos):
        ...
        dsid = make_dataid(name="l1b_chunk_offsets_north_sector")
        ds_info = {
            "name": "l1b_chunk_offsets_north_sector",
    ...
    def test_coords_generation(self, filetype_infos):
        ...
        products = ["li_l2_af_nc", "li_l2_afr_nc", "li_l2_afa_nc"]
    ...
    def test_get_area_def_acc_products(self, filetype_infos):
        ...
        handler = LIL2NCFileHandler(
            "filename", {}, extract_filetype_info(filetype_infos, "li_l2_af_nc"), with_area_definition=True
        )
    ...
    def test_get_area_def_non_acc_products(self, filetype_infos):
        ...
        handler = LIL2NCFileHandler(
            "filename", {}, extract_filetype_info(filetype_infos, "li_l2_lgr_nc"), with_area_definition=True
        )
    ...
    def handler_with_area(self, filetype_infos, product_name):
        ...
        handler = LIL2NCFileHandler(
            "filename", {}, extract_filetype_info(filetype_infos, product_name), with_area_definition=True
        )
        return handler
