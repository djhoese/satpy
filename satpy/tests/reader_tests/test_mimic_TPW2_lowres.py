...
DEFAULT_FILE_FLOAT_DATA = np.arange(DEFAULT_FILE_SHAPE[0] * DEFAULT_FILE_SHAPE[1], dtype=DEFAULT_FILE_DTYPE)
DEFAULT_FILE_DATE_DATA = np.clip(DEFAULT_FILE_FLOAT_DATA, 0, 1049)
DEFAULT_FILE_UBYTE_DATA = np.arange(DEFAULT_FILE_SHAPE[0] * DEFAULT_FILE_SHAPE[1], dtype=np.ubyte)
    ...
    def get_test_content(self, filename, filename_info, filetype_info):
        ...
        if filetype_info["file_type"] == "mimicTPW2_comp":
            ...
            for ubyte_var in ubyte_variables:
                ...
                file_content_attr[ubyte_var] = {
                    "source_key": (
                        "Key: 0: None, 1: NOAA-N, 2: NOAA-P, 3: Metop-A,                                               "
