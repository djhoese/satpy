...
class FakeHDF5FileHandler2(FakeHDF5FileHandler):
    ...
    def _get_data(self, num_scans, num_cols):
        data = {
            "Data/resolution_1km/Solar_Zenith_Angle": xr.DataArray(
                da.ones((num_scans * 4, num_cols * 4), chunks=1024, dtype=np.uint16),
                attrs={"scale": 0.01, "offset": 0.0, "fill_value": -999.0},
                dims=("x", "y"),
            ),
            "Geolocation/resolution_1km/Latitude": xr.DataArray(
                da.ones((num_scans * 4, num_cols * 4), chunks=1024, dtype=np.uint16),
                attrs={"scale": 0.01, "offset": 0.0, "fill_value": -999.0},
                dims=("x", "y"),
            ),
            "Geolocation/resolution_1km/Longitude": xr.DataArray(
                da.ones((num_scans * 4, num_cols * 4), chunks=1024, dtype=np.uint16),
                attrs={"scale": 0.01, "offset": 0.0, "fill_value": -999.0},
                dims=("x", "y"),
            ),
            "Data/resolution_1km/Radiance_01": xr.DataArray(
                da.ones((num_scans * 4, num_cols * 4), chunks=1024, dtype=np.uint16),
                attrs={"scale": 0.01, "offset": 0.0, "fill_value": -999.0, "F_solar_constant": SOLCONST},
                dims=("x", "y"),
            ),
            "Data/resolution_4km/Solar_Zenith_Angle": xr.DataArray(
                da.ones((num_scans, num_cols), chunks=1024, dtype=np.uint16),
                attrs={"scale": 0.01, "offset": 0.0, "fill_value": -999.0},
                dims=("x", "y"),
            ),
            "Geolocation/resolution_4km/Latitude": xr.DataArray(
                da.ones((num_scans, num_cols), chunks=1024, dtype=np.uint16),
                attrs={"scale": 0.01, "offset": 0.0, "fill_value": -999.0},
                dims=("x", "y"),
            ),
            "Geolocation/resolution_4km/Longitude": xr.DataArray(
                da.ones((num_scans, num_cols), chunks=1024, dtype=np.uint16),
                attrs={"scale": 0.01, "offset": 0.0, "fill_value": -999.0},
                dims=("x", "y"),
            ),
            "Data/resolution_4km/Brightness_Temperature_09": xr.DataArray(
                da.ones((num_scans, num_cols), chunks=1024, dtype=np.uint16),
                attrs={"scale": 0.01, "offset": 0.0, "fill_value": -999.0},
                dims=("x", "y"),
            ),
...
class TestMSUGSABReader:
    ...
    def test_irbt(self):
        ...
        assert res["C09"].attrs["sat_altitude"] == 38500.0
