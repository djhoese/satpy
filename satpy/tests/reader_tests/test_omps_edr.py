...
class FakeHDF5FileHandler2(FakeHDF5FileHandler):
    ...
    def get_test_content(self, filename, filename_info, filetype_info):
        ...
        if "SO2NRT" in filename:
            ...
            file_content["GEOLOCATION_DATA/Longitude/attr/_FillValue"] = -1.26765e30
            ...
            file_content["GEOLOCATION_DATA/Latitude/attr/_FillValue"] = -1.26765e30
            ...
            file_content[k] = DEFAULT_FILE_DATA
            file_content[k + "/shape"] = DEFAULT_FILE_SHAPE
            file_content[k + "/attr/_FillValue"] = -1.26765e30
            ...
            for k in ["Reflectivity331", "UVAerosolIndex"]:
                ...
                file_content[k + "/attr/_FillValue"] = -1.0
            file_content["GEOLOCATION_DATA/Longitude"] = DEFAULT_LON_DATA
            file_content["GEOLOCATION_DATA/Longitude/shape"] = DEFAULT_FILE_SHAPE
            file_content["GEOLOCATION_DATA/Longitude/attr/ValidRange"] = (-180, 180)
            file_content["GEOLOCATION_DATA/Longitude/attr/_FillValue"] = -999.0
            ...
            file_content["GEOLOCATION_DATA/Latitude/attr/_FillValue"] = -999.0
