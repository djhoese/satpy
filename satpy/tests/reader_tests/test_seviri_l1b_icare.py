...
class FakeHDF4FileHandler2(FakeHDF4FileHandler):
    ...
    def get_test_content(self, filename, filename_info, filename_type):
        ...
        file_content = {}
        file_content["/attr/Nadir_Pixel_Size"] = 3000.0
        ...
        file_content["/attr/scale_factor"] = 1.0
        file_content["/attr/add_offset"] = 0.0
        ...
        file_content["Normalized_Radiance/attr/scale_factor"] = 1.0
        file_content["Normalized_Radiance/attr/add_offset"] = 0.0
        ...
        file_content["Brightness_Temperature/attr/scale_factor"] = 1.0
        file_content["Brightness_Temperature/attr/add_offset"] = 0.0
...
class TestSEVIRIICAREReader(unittest.TestCase):
    ...
    def compare_areas(self, v):
        ...
        test_area = {
            ...
            "width": 10,
            "height": 300,
            "area_extent": (-5567248.2834071, -5570248.6866857, -5537244.2506213, -4670127.7031114),
        }
        ...
        np.testing.assert_almost_equal(v.attrs["area"].area_extent, test_area["area_extent"])

    def test_init(self):
        """Test basic init with no extra parameters."""
        r = load_reader(self.reader_configs)
        loadables = r.select_files_from_pathnames(
            ["GEO_L1B-MSG1_2004-12-29T12-15-00_G_VIS08_V1-04.hdf", "GEO_L1B-MSG1_2004-12-29T12-15-00_G_IR108_V1-04.hdf"]
        )
    ...
    def test_load_dataset_vis(self):
        ...
        r = load_reader(self.reader_configs)
        loadables = r.select_files_from_pathnames(["GEO_L1B-MSG1_2004-12-29T12-15-00_G_VIS08_V1-04.hdf"])
        r.create_filehandlers(loadables)
    ...
    def test_load_dataset_ir(self):
        """Test loading all datasets from a full swath file."""
        r = load_reader(self.reader_configs)
        loadables = r.select_files_from_pathnames(["GEO_L1B-MSG1_2004-12-29T12-15-00_G_IR108_V1-04.hdf"])
        r.create_filehandlers(loadables)
    ...
    def test_sensor_names(self):
        ...
        file_data = FakeHDF4FileHandler2.get_test_content(
            mock.MagicMock(), mock.MagicMock(), mock.MagicMock(), mock.MagicMock()
        )
        sensor_list = {
            "Meteosat-08": "MSG1/SEVIRI",
            "Meteosat-09": "MSG2/SEVIRI",
            "Meteosat-10": "MSG3/SEVIRI",
            "Meteosat-11": "MSG4/SEVIRI",
        }
        with mock.patch(
            "satpy.tests.reader_tests.test_seviri_l1b_icare.FakeHDF4FileHandler2.get_test_content"
        ) as patched_func:

            def _run_target():
                patched_func.return_value = file_data
                return self.p.target(mock.MagicMock(), mock.MagicMock(), mock.MagicMock()).sensor_name
    ...
    def test_bad_bandname(self):
        ...
        with self.assertRaises(NameError):
            self.p.target(mock.MagicMock(), mock.MagicMock(), mock.MagicMock())._get_dsname({"name": "badband"})
