...
DEFAULT_BOUND_DATA = np.arange(DEFAULT_FILE_SHAPE[0] * DEFAULT_FILE_SHAPE[1] * 4, dtype=DEFAULT_FILE_DTYPE).reshape(
    DEFAULT_FILE_SHAPE + (4,)
)
...
class FakeNetCDF4FileHandlerTL2(FakeNetCDF4FileHandler):
    ...
    def get_test_content(self, filename, filename_info, filetype_info):
        ...
        if filetype_info["file_type"] == "tropomi_l2":
            ...
            raise NotImplementedError("Test data for file types other than 'tropomi_l2' are not supported.")
