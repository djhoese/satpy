...
class FakeHDF4FileHandler2(FakeHDF4FileHandler):
    ...
    def get_test_content(self, filename, filename_info, filename_type):
        ...
        file_content["WaterDetection/attr/scale_factor"] = 1.0
        file_content["WaterDetection/attr/add_offset"] = 0.0
        file_content["WaterDetection/attr/units"] = "none"
        file_content["WaterDetection/shape"] = DEFAULT_FILE_SHAPE
        file_content["WaterDetection/attr/ProjectionMinLatitude"] = 15.0
        file_content["WaterDetection/attr/ProjectionMaxLatitude"] = 68.0
        file_content["WaterDetection/attr/ProjectionMinLongitude"] = -124.0
        file_content["WaterDetection/attr/ProjectionMaxLongitude"] = -61.0
        ...
        for key, val in file_content.items():
            if isinstance(val, np.ndarray):
                ...
                for a in [
                    "_Fillvalue",
                    "units",
                    "ProjectionMinLatitude",
                    "ProjectionMaxLongitude",
                    "ProjectionMinLongitude",
